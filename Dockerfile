...
#
# 之前 22acdbe 试过 'COPY .pnpm/@img+*@*/node_modules/@img /app/node_modules/@img' 一锅端，
# 但 Docker COPY glob 多源时按每个 source 末段命名（不是平铺），多源同名 '@img' 冲突报
# 'cannot replace to directory with file'。改回显式多 COPY——每个 @img 子包一行。
COPY --from=deps --chown=nage:nage /app/node_modules/.pnpm/@img+colour@*/node_modules/@img/colour /app/node_modules/@img/colour
COPY --from=deps --chown=nage:nage /app/node_modules/.pnpm/@img+sharp-linux-x64@*/node_modules/@img/sharp-linux-x64 /app/node_modules/@img/sharp-linux-x64
COPY --from=deps --chown=nage:nage /app/node_modules/.pnpm/@img+sharp-libvips-linux-x64@*/node_modules/@img/sharp-libvips-linux-x64 /app/node_modules/@img/sharp-libvips-linux-x64
# sharp-linux-x64 的 .node 启动时 dlopen libvips 的 .so（libvips-cpp.so.8.17.3 等），
# 在 sharp-libvips-linux-x64/lib/ 下。COPY .so 到 /usr/lib/x86_64-linux-gnu/（debian
